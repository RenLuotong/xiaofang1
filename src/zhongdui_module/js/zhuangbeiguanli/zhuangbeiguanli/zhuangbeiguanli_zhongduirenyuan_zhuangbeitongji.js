...
import zhuangbeiguanli_zhongduirenyuan_zhuangbeitongjixiangqing from './zhuangbeiguanli_zhongduirenyuan_zhuangbeitongjixiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/zhuangbeiguanli_zhongduirenyuan_zhuangbeitongjixiangqing/:leixingbianhao'} component = {zhuangbeiguanli_zhongduirenyuan_zhuangbeitongjixiangqing} />
                </Switch>
            </div>
        );
    }
        ...
        const columns = [
          {
            ...
            render: (text, record, index) => (
              <span>
                <Link to={this.props.match.url + '/zhuangbeiguanli_zhongduirenyuan_zhuangbeitongjixiangqing/' + record['leixingbianhao']}>详情</Link>
              </span>
            ),
          }
        ];
