...
import zhuangbeiguanli_zhongduirenyuan_churukujiluxiangqing from './zhuangbeiguanli_zhongduirenyuan_churukujiluxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/zhuangbeiguanli_zhongduirenyuan_churukujiluxiangqing/:id'} component = {zhuangbeiguanli_zhongduirenyuan_churukujiluxiangqing} />
                </Switch>
            </div>
        );
    }
...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
      ...
      let size = params.rows === undefined ? 10 : params.rows;
        ...
        $.ajax({
            type:'GET',
            url: SERVER + "lbzhuangbeichuruku?page="+page+"&size="+size+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&leixing="+leixing
        ...
        const columns = [{
          ...
          width: '10%'
            ...
            render: (text, record, index) => {
                return (
                    <span>
                		<Link to={this.props.match.url + '/zhuangbeiguanli_zhongduirenyuan_churukujiluxiangqing/' + record['id']}>详情</Link>
			    	</span>
                )
            },
        }];
