...
class App extends React.Component {
    ...
    fetch = (params = {
        ...
        $.ajax({
            type:'GET',
            url: SERVER + "shuxijilu/findAllBy?page="+page+"&size="+size+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&danweimingcheng="+danweimingcheng,
            dataType : 'json',
    ...
    shengcheng(id){
        $.ajax({
            type:'post',
            url: SERVER + "shuxijilu/export/"+id,
            success: function (data) {
