    ...
    $.ajax({
      ...
      success:function(data) {
        ...
        for (let i = 0; i < data.data.length; i++) {
          data.data[i]["key"] = i;
          if(data.data[i].label != '超级管理员' && data.data[i].label != '支队管理员'&& data.data[i].label != '中队长'&& data.data[i].label != '消防员'&& data.data[i].label != '二级库管员'&& data.data[i].label != '一级库管员'&& data.data[i].label != '大队长'&& data.data[i].label != '后勤处处长'&& data.data[i].label != '装备科科长'&& data.data[i].label != '战斗班长'){
