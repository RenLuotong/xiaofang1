	...
	componentDidMount () {
  	...
  	render() {
	    ...
	    return (
	      	<div>
				<label>保管柜名称:</label>
				<Input size="default"  name="baoguanguimingcheng" id="baoguanguimingcheng" style={{margin:10,width:200}} value={info['baoguanguimingcheng']} onChange={this.handleInputChange.bind(this)}/>
				<label>设备编号:</label>
