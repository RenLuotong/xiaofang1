    ...
    getInfo() {
        ...
        $.ajax({
            ...
            success : function (data) {
                ...
                for (let i = 0; i < data.data.baimingdanlist.length; i++) {
                    data.data.baimingdanlist[i]["key"] = i;
                    if (data.data.baimingdanlist[i]["gengxinshijian"] != null && data.data.baimingdanlist[i]["gengxinshijian"] != "") {
                        data.data.baimingdanlist[i]["gengxinshijian"] = moment(data.data.baimingdanlist[i]["gengxinshijian"]).format('YYYY-MM-DD HH:mm:ss');
                    }
                    list.push(data.data.baimingdanlist[i]);
                }
                THE.setState({
