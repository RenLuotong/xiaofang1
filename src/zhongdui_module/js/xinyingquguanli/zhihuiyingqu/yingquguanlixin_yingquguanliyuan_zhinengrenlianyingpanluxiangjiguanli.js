...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        let sblx = "RENLIANYINGPANLUXIANGJI";
        $.ajax({
            type:'get',
    ...
    render() {
        const columns = [{
          ...
          width: '10%'
            ...
            render: (text, record) => (
                <span>
                    <Popconfirm placement="topLeft" title="确认要删除智能人脸硬盘录像机?"
                                onConfirm={this.toDelete.bind(this, record['id'])} okText="确认" cancelText="取消">
                        <a>删除</a>
                    </Popconfirm>
                    <Divider type="vertical"/>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_zhinengrenlianyingpanluxiangjixiugai/' + record['id']}>修改</Link>
                </span>
            ),
        },];
        ...
        return (
            <div>
                <Button style={{margin: 5}}>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_zhinengrenlianyingpanluxiangjitianjia'}><Icon type="plus"/><span>添加智能人脸硬盘录像机</span></Link>
                </Button>
