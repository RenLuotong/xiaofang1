...
import yingquguanlixin_yingquguanliyuan_yingpanluxiangjiguanlixiugai from './yingquguanlixin_yingquguanliyuan_yingpanluxiangjiguanlixiugai';
import yingquguanlixin_yingquguanliyuan_yingpanluxiangjiguanlitianjia from './yingquguanlixin_yingquguanliyuan_yingpanluxiangjiguanlitianjia';
    ...
    output() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // 导出 Excel
                XLSX.writeFile(wb, '硬盘录像机管理.xlsx');
            }
        });
    ...
    render() {
        const columns = [{
          ...
          width: '10%'
            ...
            render: (text, record) => (
                <span>
                    <Popconfirm placement="topLeft" title="确认要删除该硬盘录像机?"
                                onConfirm={this.toDelete.bind(this, record['id'])} okText="确认" cancelText="取消">
                        <a>删除</a>
                    </Popconfirm>
                    <Divider type="vertical"/>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_yingpanluxiangjiguanlixiugai/' + record['id']}>修改</Link>
                </span>
            ),
        },];
        ...
        return (
            <div>
                <Button style={{margin: 5}}>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_yingpanluxiangjiguanlitianjia'}><Icon type="plus"/><span>添加硬盘录像机</span></Link>
                </Button>
