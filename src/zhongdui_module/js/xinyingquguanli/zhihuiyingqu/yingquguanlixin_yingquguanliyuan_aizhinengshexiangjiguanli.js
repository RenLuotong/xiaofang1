...
import yingquguanlixin_yingquguanliyuan_aizhinengshexiangjiguanlixiugai from './yingquguanlixin_yingquguanliyuan_aizhinengshexiangjiguanlixiugai';
import yingquguanlixin_yingquguanliyuan_aizhinengshexiangjiguanlitianjia from './yingquguanlixin_yingquguanliyuan_aizhinengshexiangjiguanlitianjia';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (_data == null || _data.length == 0) {
                    message.warning("AI智能摄像机管理列表没有数据！");
                    return;
                }
                ...
                // 导出 Excel
                XLSX.writeFile(wb, 'AI智能摄像机管理.xlsx');
            }
        });
    ...
    render() {
        const columns = [{
          ...
          width: '10%'
            ...
            render: (text, record) => (
                <span>
                    <Popconfirm placement="topLeft" title="确认要删除该AI智能摄像机?"
                                onConfirm={this.toDelete.bind(this, record['id'])} okText="确认" cancelText="取消">
                        <a>删除</a>
                    </Popconfirm>
                    <Divider type="vertical"/>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_aizhinengshexiangjiguanlixiugai/' + record['id']}>修改</Link>
                </span>
            ),
        },];
        ...
        return (
            <div>
                <Button style={{margin: 5}}>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_aizhinengshexiangjiguanlitianjia'}><Icon type="plus"/><span>添加AI智能摄像机</span></Link>
                </Button>
