...
import yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxiangqing from './yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxiangqing';
import yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxinzeng from './yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxinzeng'
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxiangqing/:id'} component = {yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxiangqing} />
                    <Route path = {this.props.match.path +'/yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxinzeng'} component = {yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxinzeng} />
        ...
        return (
            <div>
                <Form onSubmit={this.handleSubmit} layout="inline" style={{margin:5}}>
                    ...
                    {/*<FormItem>*/}
                    {/*    <Button>*/}
                    {/*        <Link to={this.props.match.url + '/yingquguanlixin_zhishiguanliyuan_zhishiwenzhangneirongxinzeng'}>*/}
