...
import yingquguanlixin_yingquguanliyuan_zhinengchengguanlixiugai from './yingquguanlixin_yingquguanliyuan_zhinengchengguanlixiugai';
import yingquguanlixin_yingquguanliyuan_zhinengchengguanlitianjia from './yingquguanlixin_yingquguanliyuan_zhinengchengguanlitianjia';
    ...
    render() {
        const columns = [{
          ...
          width: '10%'
            ...
            render: (text, record) => (
                <span>
                    <Popconfirm placement="topLeft" title="确认要删除该智能秤?"
                                onConfirm={this.toDelete.bind(this, record['id'])} okText="确认" cancelText="取消">
                        <a>删除</a>
                    </Popconfirm>
                    <Divider type="vertical"/>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_zhinengchengguanlixiugai/' + record['id']}>修改</Link>
                </span>
            ),
        },];
        ...
        return (
            <div>
                <Button style={{margin: 5}}>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_zhinengchengguanlitianjia'}><Icon type="plus"/><span>添加智能秤</span></Link>
                </Button>
