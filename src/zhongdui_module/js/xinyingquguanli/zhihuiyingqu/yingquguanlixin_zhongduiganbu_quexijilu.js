...
import {
    ...
    Divider,
    Popconfirm,
    message, DatePicker, Form, Input, Card, Tree, Select
} from 'antd';
...
class App extends Component {
    ...
    fetch = (params = {
        ...
        $.ajax({
            type: 'get',
            url: SERVER + "tb_zhibanquexi/chaxunQuegangjilu?page=" + page + "&size=" + size + "&kaishishijian=" + kaishishijian + "&jieshushijian=" + jieshushijian +"&chakanfanwei="+chakanfanwei+"&jigoudaima="+jigoudaima+ "&quexirenxingming=" + extraQuexirenXingming,
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
    ...
    output() {
        ...
        $.ajax({
            type: 'get',
            url: SERVER + "tb_zhibanquexi/chaxunQuegangjilu?page=0&size=10000&kaishishijian=" + kaishishijian + "&jieshushijian=" + jieshushijian +"&chakanfanwei="+chakanfanwei+"&jigoudaima="+jigoudaima+ "&quexirenxingming=" + extraQuexirenXingming,
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
