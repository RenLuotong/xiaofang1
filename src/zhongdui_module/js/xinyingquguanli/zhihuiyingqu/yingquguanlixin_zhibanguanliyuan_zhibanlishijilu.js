          ...
          width: '10%'
                ...
                render: (text, record, index) => {
                    if (record['shenhezhuangtai'] == "申请中") {
                        return (
                            <span>
                                <Link to={'yingquguanlixin_xiaofangyuan_zhibanlishijilu/yingquguanlixin_zhongduiganbu_zhibanlishijiluxiangqing/'+ record['id'] }>详情</Link>
                       </span>
                        )
                    }else {
                        return(
            ...
            <div>
                <Form onSubmit={this.handleSubmit} layout="inline" style={{margin: 5}}>
                    ...
                    <FormItem>
                        <Button>
                            <Link
                                to={'yingquguanlixin_xiaofangyuan_zhibanlishijilu/yingquguanlixin_zhongduiganbu_zhibanlishijiluxinzeng'}><Icon
