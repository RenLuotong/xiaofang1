...
import yingquguanlixin_xiaofangyuan_chayuezhishiwenzhangneirongxiangqing from './yingquguanlixin_xiaofangyuan_chayuezhishiwenzhangneirongxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_xiaofangyuan_chayuezhishiwenzhangneirongxiangqing/:id'} component = {yingquguanlixin_xiaofangyuan_chayuezhishiwenzhangneirongxiangqing} />
                </Switch>
            </div>
        );
    }
    ...
    render() {
        ...
        const columns = [{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                           <Link to={this.props.match.url + '/yingquguanlixin_xiaofangyuan_chayuezhishiwenzhangneirongxiangqing/' + record['id']}>详情</Link>
                       </span>
                )
            },
        }];
