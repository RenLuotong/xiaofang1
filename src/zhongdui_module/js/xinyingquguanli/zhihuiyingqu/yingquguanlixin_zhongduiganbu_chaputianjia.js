...
class App extends React.Component {
    ...
    backPage() {
        ...
        if(role=="中队"){
            window.location.href = "./zhongdui.html#/yingquguanli_zhongduiganbu_chapushezhi";
        }
        else if (role=="大队") {
            window.location.href = "./dadui.html#/yingquguanli_zhongduiganbu_chapushezhi";
        }else {
            window.location.href = "./zhidui.html#/yingquguanli_zhongduiganbu_chapushezhi";
        }
    }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.data.content.length; i++) {
                    ...
                    if (data.data.content[i].yongtu == "查铺") {
