...
import {
    ...
    Divider,
    Popconfirm,
    message, DatePicker, Form, Input, Modal, Card, Tree, Select
} from 'antd';
...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER + "chaxunYingqujiaogangjilu?page="+page+"&size="+size+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&beijiaogangrenxingming="+beijiaogangrenxingming+"&chakanfanwei="+chakanfanwei+"&jigoudaima="+jigoudaima+ "&extrajiaogangrenxingming="+extrajiaogangrenxingming,
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
    ...
    output() {
        ...
        $.ajax({
            type:'get',
            url: SERVER + "chaxunYingqujiaogangjilu?page=0&size=10000&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&beijiaogangrenxingming="+beijiaogangrenxingming+"&chakanfanwei="+chakanfanwei+"&jigoudaima="+jigoudaima+ "&extrajiaogangrenxingming="+extrajiaogangrenxingming,
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
