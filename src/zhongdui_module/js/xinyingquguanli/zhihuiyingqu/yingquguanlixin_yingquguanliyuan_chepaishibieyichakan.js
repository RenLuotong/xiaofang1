...
import yingquguanlixin_yingquguanliyuan_chepaishibieyixiugai from './yingquguanlixin_yingquguanliyuan_chepaishibieyixiugai';
import yingquguanlixin_yingquguanliyuan_chepaishibieyixiangqing from './yingquguanlixin_yingquguanliyuan_chepaishibieyixiangqing';
import yingquguanlixin_yingquguanliyuan_chepaishibieyitianjia from './yingquguanlixin_yingquguanliyuan_chepaishibieyitianjia';
    ...
    output() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // 导出 Excel
                XLSX.writeFile(wb, '车牌识别仪管理.xlsx');
            }
        });
    ...
    render() {
        const columns = [{
          ...
          width: '10%'
            ...
            render: (text, record) => (
                <span>
                    {/*<Link to={this.props.match.url + '/yingquguanlixin_yingquguanliyuan_chepaishibieyixiangqing/' + record['id']}>详情</Link>*/}
                    {/*<Divider type="vertical"/>*/}
                    <Popconfirm placement="topLeft" title="确认要删除该车牌识别仪?"
                                onConfirm={this.toDelete.bind(this, record['id'])} okText="确认" cancelText="取消">
                        <a>删除</a>
                    </Popconfirm>
                    <Divider type="vertical"/>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_chepaishibieyixiugai/' + record['id']}>修改</Link>
                </span>
            ),
        },];
        ...
        return (
            <div>
                <Button style={{margin: 5}}>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_chepaishibieyitianjia'}><Icon type="plus"/><span>添加车牌识别仪</span></Link>
                </Button>
