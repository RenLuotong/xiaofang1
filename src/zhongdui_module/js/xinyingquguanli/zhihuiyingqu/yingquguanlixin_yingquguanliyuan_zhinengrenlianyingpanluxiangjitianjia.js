...
class App extends React.Component {
    ...
    toCreate() {
        ...
        let renliankuid = form.getFieldValue('renliankuid');
        let obj = {};
        obj["shebeixuliehao"] = shebeixuliehao;
        obj["shebeileixing"] = "RENLIANYINGPANLUXIANGJI";
            ...
            <div>
                <LocaleProvider locale={zh_CN}>
                    <Form layout="inline" onSubmit={this.handleSubmit}>
                        ...
                        <FormItem label="设备用途">
                            {getFieldDecorator('yongtu', {
                                ...
                                <Select style={{margin:5,width:200}}>
                                    <Select.Option value="RENLIANDUIBI">人脸对比</Select.Option>
                                </Select>
                            )}
                        </FormItem>
                        <FormItem label="生产厂家">
                        ...
                        <br/>
                        <FormItem label="人脸库ID">
                            {getFieldDecorator('renliankuid', {
                                rules: [{ required: true, message: '请输入人脸库ID', whitespace: true }],
                            })(
                                <Input style={{margin:5,width:200}}/>
                            )}
                        </FormItem>
