...
import yingquguanlixin_yingquguanliyuan_renlianshibieyichakanxiugai from './yingquguanlixin_yingquguanliyuan_renlianshibieyichakanxiugai';
import yingquguanlixin_yingquguanliyuan_renlianshibieyichakanxiangqing from './yingquguanlixin_yingquguanliyuan_renlianshibieyichakanxiangqing';
import yingquguanlixin_yingquguanliyuan_renlianshibieyichakantianjia from './yingquguanlixin_yingquguanliyuan_renlianshibieyichakantianjia';
    ...
    output() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // 导出 Excel
                XLSX.writeFile(wb, '人脸识别仪管理.xlsx');
            }
        });
    ...
    render() {
        const columns = [{
          ...
          width: '10%'
            ...
            render: (text, record) => (
                <span>
                    {/*<Link to={this.props.match.url + '/yingquguanli_zhongduiganbu_renlianshibieyixiangqing/' + record['id']}>详情</Link>*/}
                    {/*<Divider type="vertical"/>*/}
                    <Popconfirm placement="topLeft" title="确认要删除该人脸识别仪?"
                                onConfirm={this.toDelete.bind(this, record['id'])} okText="确认" cancelText="取消">
                        <a>删除</a>
                    </Popconfirm>
                    <Divider type="vertical"/>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_renlianshibieyichakanxiugai/' + record['id']}>修改</Link>
                </span>
            ),
        },];
        ...
        return (
            <div>
                <Button style={{margin: 5}}>
                    <Link to={'yingquguanlixin_zhongduiganbu_kaoqinjiguanli/yingquguanlixin_yingquguanliyuan_renlianshibieyichakantianjia'}><Icon type="plus" /><span>添加人脸识别仪</span></Link>
                </Button>
