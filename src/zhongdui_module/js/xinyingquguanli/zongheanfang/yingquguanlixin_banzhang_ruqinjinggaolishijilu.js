...
import yingquguanlixin_banzhang_ruqinjinggaolishijiluxiangqing from './yingquguanlixin_banzhang_ruqinjinggaolishijiluxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_banzhang_ruqinjinggaolishijiluxiangqing/:id'} component = {yingquguanlixin_banzhang_ruqinjinggaolishijiluxiangqing} />
                </Switch>
            </div>
        );
    }
...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER + "chaxunzhoujieruqingaojingjilu?page="+page+"&size="+size+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian,
    ...
    render() {
        const columns = [{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                          	<Link to={this.props.match.url+'/yingquguanlixin_banzhang_ruqinjinggaolishijiluxiangqing/' + record['id'] }>详情</Link>
                       </span>
                )
            },
        }];
