...
import yingquguanlixin_xiaofangyuan_dazhongdianpingxiangqing from './yingquguanlixin_xiaofangyuan_dazhongdianpingxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_xiaofangyuan_dazhongdianpingxiangqing/:caipinpingjiazhubiaobianhao'} component = {yingquguanlixin_xiaofangyuan_dazhongdianpingxiangqing} />
                </Switch>
            </div>
        );
    }
    ...
    render() {
        ...
        const columns = [{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                           <Link to={this.props.match.url + '/yingquguanlixin_xiaofangyuan_dazhongdianpingxiangqing/' + record['caipinpingjiazhubiaobianhao']}>详情</Link>
                       </span>
                )
            },
        }];
