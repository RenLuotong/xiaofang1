...
import yingquguanlixin_zhongduiganbu_xiaodujiluxiangqing from './yingquguanlixin_zhongduiganbu_xiaodujiluxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_zhongduiganbu_xiaodujiluxiangqing/:id'} component = {yingquguanlixin_zhongduiganbu_xiaodujiluxiangqing} />
                </Switch>
            </div>
        );
    }
    ...
    render() {
        const columns = [{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                          	<Link to={this.props.match.url+'/yingquguanlixin_zhongduiganbu_xiaodujiluxiangqing/' + record['id'] }>详情</Link>
                       </span>
                )
            },
        }];
