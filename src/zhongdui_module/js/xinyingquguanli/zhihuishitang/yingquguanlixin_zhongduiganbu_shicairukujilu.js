...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER + "chaxunshicairukujiluNew?page="+page+"&size="+size+"&shicaimingcheng="+shicaimingcheng+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&chakanfanwei="+chakanfanwei+"&jigoudaima="+jigoudaima,
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
    ...
    render() {
        ...
        const columns = [{
            ...
            title: '设备识别结果',
            dataIndex: 'shicaishibiemingcheng',
        },{
            title: '价格',
            dataIndex: 'jiage',
        },{
            title: '数量或重量',
            dataIndex: 'rukuzhongliang',
        }];
