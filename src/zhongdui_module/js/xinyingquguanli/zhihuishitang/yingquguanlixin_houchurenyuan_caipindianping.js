...
import yingquguanlixin_houchurenyuan_caipindianpingxiangqing from './yingquguanlixin_houchurenyuan_caipindianpingxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_houchurenyuan_caipindianpingxiangqing/:caipinpingjiazhubiaobianhao'} component = {yingquguanlixin_houchurenyuan_caipindianpingxiangqing} />
                </Switch>
            </div>
        );
    }
    ...
    render() {
        ...
        ,{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                           <Link to={this.props.match.url + '/yingquguanlixin_houchurenyuan_caipindianpingxiangqing/' + record['caipinpingjiazhubiaobianhao']}>详情</Link>
                       </span>
                )
            },
        }];
