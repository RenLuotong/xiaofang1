...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER + "chaxunxiaofangyuanHuojishujiedaishiShiyongjilu?page="+page+"&size="+size+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&fangjianmingcheng="+fangjianmingcheng+"&shenpizhuangtai="+shenpizhuangtai+"&fangjianleixing="+fangjianleixing+paixu,
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
        ...
        return (
            <div>
                ...
                <Table
                    ...
                    scroll={{ y: "calc(100vh - 385px)", x: true }}
                />
            </div>
        );
    }
