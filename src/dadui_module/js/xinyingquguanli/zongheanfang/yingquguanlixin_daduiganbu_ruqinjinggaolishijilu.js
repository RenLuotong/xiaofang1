...
import yingquguanlixin_daduiganbu_ruqinjinggaolishijiluxiangqing from './yingquguanlixin_daduiganbu_ruqinjinggaolishijiluxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_daduiganbu_ruqinjinggaolishijiluxiangqing/:id'} component = {yingquguanlixin_daduiganbu_ruqinjinggaolishijiluxiangqing} />
                </Switch>
            </div>
        );
    }
    ...
    render() {
        ...
        const columns = [{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                          	<Link to={this.props.match.url+'/yingquguanlixin_daduiganbu_ruqinjinggaolishijiluxiangqing/' + record['id'] }>详情</Link>
                       </span>
                )
            },
        }];
