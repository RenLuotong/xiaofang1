...
import yingquguanlixin_daduiganbu_zhibanlishijiluxiangqing from "./yingquguanlixin_daduiganbu_zhibanlishijiluxiangqing";
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_daduiganbu_zhibanlishijiluxiangqing/:id'} component = {yingquguanlixin_daduiganbu_zhibanlishijiluxiangqing} />
                </Switch>
            </div>
        );
    }
...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER + "tb_zhiban/daduizhiduiZhibanliebiao?page="+page+"&size="+size+"&chaxunqishishijian="+kaishishijian+"&chaxunjiezhishijian="+jieshushijian+"&auditStateType="+shenhezhuangtai+"&jigoudaima="+jigoumingcheng+"&sort=jihuakaishishijian,desc",
    ...
    output() {
        ...
        $.ajax({
            type:'get',
            url: SERVER + "tb_zhiban/daduizhiduiZhibanliebiao?page=0&size=10000&chaxunqishishijian="+kaishishijian+"&chaxunjiezhishijian="+jieshushijian+"&auditStateType="+shenhezhuangtai+"&jigoudaima="+jigoumingcheng+"&sort=jihuakaishishijian,desc",
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
    ...
    render() {
        ...
        ,{
            ...
            render: (text, record) => (
                <span>
                    <Link to={this.props.match.url+'/yingquguanlixin_daduiganbu_zhibanlishijiluxiangqing/'+ record['id'] }>详情</Link>
			    </span>
            ),
        },];
        ...
        let jigou = getFieldValue('jigoumingcheng');
        if (typeof(jigou) == "undefined"|| jigou == '-1') {
            jigou = "";
        }
                ...
                <Form onSubmit={this.handleSubmit} layout="inline" style={{margin: 5}}>
                    ...
                    <FormItem>
                        <Button type="primary" onClick={this.search.bind(this)}>
                            <Icon type="search"/>导出EXCEL
                        </Button>
                    </FormItem>
                    <FormItem>
                        <Button type="primary" >
                            <a href={SERVER+'tb_zhiban/shengchengdaduizhiduiZhibanliebiaobufenye?kaishishijian='+kaishishijian+'&jieshushijian='+jieshushijian+'&jigoudaima='+jigou+'&renyuanbianhao='+renyuanbianhao} title="导出PDF" target="_blank">导出PDF</a>
                        </Button>
                    </FormItem>
                    <br/>
                </Form>
