...
import yingquguanlixin_daduiganbu_yichangtuogangjiluxiangqing from './yingquguanlixin_daduiganbu_yichangtuogangjiluxiangqing';
const View = [];
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_daduiganbu_yichangtuogangjiluxiangqing/:id'} component = {yingquguanlixin_daduiganbu_yichangtuogangjiluxiangqing} />
                </Switch>
            </div>
        );
    }
...
class App extends Component {
    ...
    output() {
        ...
        $.ajax({
            type:'get',
            url: SERVER + "tb_zhibantuogang/huoqusuoyoutuogangjilu?page=0&size=10000&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&shejirenyuan="+shejirenyuan+"&shifoushensu="+shifoushensu+"&jigoudaima="+jigoumingcheng,
            success: function (data) {
                let list = [];
                if (data.status != 0) {
                    message.warning(data.message);
    ...
    render() {
        ...
        const columns = [{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                           <Link to={this.props.match.url + '/yingquguanlixin_daduiganbu_yichangtuogangjiluxiangqing/' + record['id']}>详情</Link>
                       </span>
                )
            },
        }];
