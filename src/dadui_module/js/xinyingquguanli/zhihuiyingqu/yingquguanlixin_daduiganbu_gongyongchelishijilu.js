...
import {
    ...
    Button,
    Table,
    message, Select, Card, Tree, Tabs, Divider
} from 'antd';
const { TreeNode } = Tree;
...
class App extends React.Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER+"huoqugongwucheyongchejiluByjigoudaima?page="+page+"&size="+size+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&shenqingren="+shenqingren+"&shenpizhuangtai="+shenpizhuangtai+"&shifouchaoqi="+shifouchaoqi+"&chepaihaoma="+chepaihaoma+"&jigoudaima="+jigoudaima+paixu,
            data : JSON.stringify(),
            dataType : 'json',
    ...
    output()  {
        ...
        $.ajax({
            type:'get',
            url: SERVER+"huoqugongwucheyongchejiluByjigoudaima?page=0&size=100000&chepaihaoma="+chepaihaoma+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&shenqingren="+shenqingren+"&shenpizhuangtai="+shenpizhuangtai+"&shifouchaoqi="+shifouchaoqi+"&jigoudaima="+jigoudaima,
            data : JSON.stringify(),
            dataType : 'json',
            contentType : "application/json",
            success: function (data) {
