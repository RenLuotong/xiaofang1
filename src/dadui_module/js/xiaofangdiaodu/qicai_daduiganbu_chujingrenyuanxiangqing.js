...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'GET',
            url: SERVER + "huoquchujingjiluByrenyuanbianhao?page="+page+"&size="+size+"&renyuanbianhao="+renyuanbianhao+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&sort=id,desc",
