...
//引入中队模块人员功能
import renyuanguanli_zhongduiguanliyuan_renyuanguanli
	from "../../../zhongdui_module/js/renyuanguanli/renyuanguanli/renyuanguanli_zhongduiguanliyuan_renyuanguanli";
import yingquguanlixin_zhishiguanliyuan_zhishiwenzhang
	from "../../../zhongdui_module/js/xinyingquguanli/zhihuiyingqu/yingquguanlixin_zhishiguanliyuan_zhishiwenzhang";
...
import renyuanguanli_zhongduiganbu_nianxiutianshuguanli from "../../../zhongdui_module/js/renyuanguanli/renyuanguanli/renyuanguanli_zhongduiganbu_nianxiutianshuguanli";
//其他按钮相关
import daibanshixiang_daduiganbu_daibanshixiang from '../daibanshixiang/daibanshixiang_daduiganbu_daibanshixiang.js';
...
//装备管理
import zhuangbeiguanli_daduirenyuan_zhuangbeitongji from '../zhuangbeiguanli/zhuangbeiguanli_daduirenyuan_zhuangbeitongji.js';
//消防调度
import qicai_daduiganbu_chujingjilu from '../xiaofangdiaodu/qicai_daduiganbu_chujingjilu.js';
import qicai_daduiganbu_chujingxinxi from '../xiaofangdiaodu/qicai_daduiganbu_chujingxinxi.js';
...
import shuju_zhongdui_zhongdiandanweiguanli from '../xiaofangdiaodu/shuju_dadui_zhongdiandanweiguanli.js';
...
class App extends React.Component {
	...
	//???
  	...
  	user_menu_dropdown_click = ({ key }) => {
  		if(key == "1"){
  			window.location.href = "dadui.html#/zhgl";
  		}
  		if(key == "2"){
            ...
            <Header id="zhuye_header_div" style={{ backgroundColor: '#3460AB', borderBottom:'1px solid #e8e8e8' }}>
              ...
              <div className="tongjiNavRight" style={{justifyContent: 'center',width: '11%'}}>
        		...
        		<Layout id="layout_div">
					<Sider className="mySider_left"  style={{ backgroundColor: '#3460AB', width: 200 }}>
						<Menu
							mode="inline"
              theme="dark"
					...
					<Content id="root_content_div">
						...
						<div className='root_content_div_box'>
							<Switch>
								...
								{/*其他按钮用*/}
								<Route path="/daibanshixiang_daduiganbu_daibanshixiang" component={daibanshixiang_daduiganbu_daibanshixiang}  />
								{/*新营区管理*/}
								{/*二期菜单*/}
								{/*引入中队营区功能*/}
								...
								{/*装备管理*/}
								<Route path="/zhuangbeiguanli_daduirenyuan_zhuangbeitongji" component={zhuangbeiguanli_daduirenyuan_zhuangbeitongji}/>
								<Route path="/qicai_daduiganbu_chujingjilu" component={qicai_daduiganbu_chujingjilu}/>
								<Route path="/qicai_daduiganbu_chujingxinxi" component={qicai_daduiganbu_chujingxinxi}/>
