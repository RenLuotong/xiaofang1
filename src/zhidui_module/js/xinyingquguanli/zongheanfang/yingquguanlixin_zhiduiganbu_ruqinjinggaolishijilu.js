...
import yingquguanlixin_zhiduiganbu_ruqinjinggaolishijiluxiangqing from './yingquguanlixin_zhiduiganbu_ruqinjinggaolishijiluxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_zhiduiganbu_ruqinjinggaolishijiluxiangqing/:id'} component = {yingquguanlixin_zhiduiganbu_ruqinjinggaolishijiluxiangqing} />
                </Switch>
            </div>
        );
    }
...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER + "chaxunzhoujieruqingaojingjilu/all?page="+page+"&size="+size+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&yingqvbianhao="+jigoumingcheng,
    ...
    render() {
        ...
        const columns = [{
            ...
            render: (text, record, index) => {
                return (
                    <span>
                          	<Link to={this.props.match.url+'/yingquguanlixin_zhiduiganbu_ruqinjinggaolishijiluxiangqing/' + record['id'] }>详情</Link>
                       </span>
                )
            },
        }];
