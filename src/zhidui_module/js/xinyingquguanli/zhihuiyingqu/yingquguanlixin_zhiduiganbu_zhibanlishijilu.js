...
import yingquguanlixin_zhiduiganbu_zhibanlishijiluxiangqing from "./yingquguanlixin_zhiduiganbu_zhibanlishijiluxiangqing";
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/yingquguanlixin_zhiduiganbu_zhibanlishijiluxiangqing/:id'} component = {yingquguanlixin_zhiduiganbu_zhibanlishijiluxiangqing} />
                </Switch>
            </div>
        );
    }
...
class App extends Component {
    ...
    render() {
        ...
        // },
            ...
            render: (text, record) => (
                <span>
                    <Link to={this.props.match.url+'/yingquguanlixin_zhiduiganbu_zhibanlishijiluxiangqing/'+ record['id'] }>详情</Link>
			    </span>
            ),
        },];
