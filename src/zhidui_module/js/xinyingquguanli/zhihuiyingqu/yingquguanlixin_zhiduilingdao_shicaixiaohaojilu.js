...
class App extends Component {
    ...
    fetch = (params = {rows: this.state.pagination.pageSize,
        ...
        $.ajax({
            type:'get',
            url: SERVER + "chaxunxiaohaojilu/all?page="+page+"&size="+size+"&shicaimingcheng="+shicaimingcheng+"&kaishishijian="+kaishishijian+"&jieshushijian="+jieshushijian+"&yingqvbianhao="+jigoumingcheng,
