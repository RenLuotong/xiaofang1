...
class App extends Component {
    ...
    toCreate() {
        ...
        let wenzhangleixing = this.wenzhangleixing;
        if (wenzhangleixing == ""||wenzhangleixing == null||wenzhangleixing ==  "undefined") {
            message.error("请选择文章类型！");return;
        }
        ...
        wenzhangAO["lianjie"] = lianjiedizhi;
        $.ajax({
            type:'post',
            url:SERVER+"tb-wenzhangs/xinzeng?leixing="+wenzhangleixing,
    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <label>文章类型:</label>
                <Select style={{margin:10,width:200}} onChange={this.wenzhangleixingChang.bind(this)}>
