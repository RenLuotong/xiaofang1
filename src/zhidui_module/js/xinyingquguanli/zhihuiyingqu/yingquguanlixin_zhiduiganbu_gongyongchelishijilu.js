        ...
        <Switch>
          ...
          <Route
            path={
              ...
              "/yingquguanlixin_cheliangguanliyuan_yongchelishijiluxiangqing/:chepaihaoma/:paichekaishishijian/:paichejieshushijian"
            }
            component={
              yingquguanlixin_cheliangguanliyuan_yongchelishijiluxiangqing
            }
          />
          <Route
            path={
              this.props.match.path +
              "/yingquguanlixin_cheliangguanliyuan_yongchelishijiluqingkuang/:shenqingdanbianhao"
            }
            component={
              yingquguanlixin_cheliangguanliyuan_yongchelishijiluqingkuang
            }
          />
        </Switch>
      </div>
...
class App extends React.Component {
  ...
  fetch = (
    ...
    $.ajax({
      ...
      url:
        SERVER +
        "huoqugongwucheyongchejiluByjigoudaima?page=" +
        page +
        "&size=" +
        size +
        "&kaishishijian=" +
  ...
  output() {
    ...
    $.ajax({
      ...
      url:
        SERVER +
        "huoqugongwucheyongchejiluByjigoudaima?page=0&size=100000&chepaihaoma=" +
        chepaihaoma +
        "&kaishishijian=" +
        kaishishijian +
        "&jieshushijian=" +
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record, index) => {
          if (
            record["chuyingshijian"] !== undefined &&
            record["guiyingshijian"] !== undefined
          ) {
            return (
              <span>
                <Link
                ...
                <Link
                  to={
                    ...
                    record["chepaihaoma"] +
                    "/" +
                    record["chuyingshijian"] +
                    "/" +
                    record["guiyingshijian"]
                  }
                >
                  轨迹
                </Link>
    ...
    tableList = (
      <div>
        ...
        >
          ...
          <br />
          <FormItem label="申请人&#12288;">
            {getFieldDecorator("shenqingren")(<Input style={{ width: 200 }} />)}
          </FormItem>
          <FormItem label="审批状态">
