...
class App extends Component {
  ...
  fetch = (
    ...
    $.ajax({
      ...
      url:
        SERVER +
        "tb_zhibanquexi/houqujigouquexijilu?page=" +
        page +
        "&size=" +
        size +
        "&kaishishijian=" +
      ...
      success: function (data) {
        ...
        for (let i = 0; i < data.data.content.length; i++) {
          ...
          data.data.content[i]["extraJihuakaishishijian"] = moment(
            data.data.content[i]["extraJihuakaishishijian"]
          ).format("YYYY-MM-DD HH:mm:ss");
          data.data.content[i]["extraJihuajieshushijian"] = moment(
            data.data.content[i]["extraJihuajieshushijian"]
          ).format("YYYY-MM-DD HH:mm:ss");
  ...
  output() {
    ...
    $.ajax({
      ...
      url:
        SERVER +
        "tb_zhibanquexi/houqujigouquexijilu?page=0&size=10000&kaishishijian=" +
        kaishishijian +
        "&jieshushijian=" +
        jieshushijian +
        "&quexirenxingming=" +
