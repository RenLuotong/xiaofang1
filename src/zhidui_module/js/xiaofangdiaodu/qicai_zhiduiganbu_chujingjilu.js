...
import chujingjiluxiangqing from "./qicai_zhiduiganbu_chujingjiluxiangqing";
import qicai_zhiduiganbu_chujingrenyuanxiangqing from "./qicai_zhiduiganbu_chujingrenyuanxiangqing";
import qicai_zhiduiganbu_chujingcheliangxiangqing from "./qicai_zhiduiganbu_chujingcheliangxiangqing";
        ...
        <Switch>
          ...
          <Route
            path={
              ...
              "/qicai_zhiduiganbu_chujingrenyuanxiangqing/:renyuanbianhao"
            }
            component={qicai_zhiduiganbu_chujingrenyuanxiangqing}
          />
          <Route
            path={
              this.props.match.path +
              "/qicai_zhiduiganbu_chujingcheliangxiangqing/:cheliangbianhao"
            }
            component={qicai_zhiduiganbu_chujingcheliangxiangqing}
          />
        </Switch>
      </div>
    );
          ...
          <span>
            <Link
              to={
                ...
                "/qicai_zhiduiganbu_chujingrenyuanxiangqing/" +
        ...
        render: (text, record, index) => (
          <span>
            <Link
              to={
                this.props.match.url +
                "/qicai_zhiduiganbu_chujingcheliangxiangqing/" +
