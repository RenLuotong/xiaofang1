...
import zhuangbeiguanli_zhiduirenyuan_zhuangbeichaxunxiangqing from './zhuangbeiguanli_zhiduirenyuan_zhuangbeichaxunxiangqing';
        ...
        return(
            <div>
                <Switch>
                    ...
                    <Route path = {this.props.match.path +'/zhuangbeiguanli_zhiduirenyuan_zhuangbeichaxunxiangqing/:leixingbianhao'} component = {zhuangbeiguanli_zhiduirenyuan_zhuangbeichaxunxiangqing} />
                </Switch>
            </div>
        );
    }
    ...
    render() {
        ...
        const columns = [{
                ...
                render: (text, record, index) => (
                    <span>
                    	<Link to={this.props.match.url + '/zhuangbeiguanli_zhiduirenyuan_zhuangbeichaxunxiangqing/' + record['leixingbianhao']}>详情</Link>
			    	</span>
                ),
            }
        ];
