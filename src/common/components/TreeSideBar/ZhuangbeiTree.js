...
class ZhuangbeiTree extends Component {
  constructor(props) {
    super(props)
    this.state = {
      collapsed: false,
  ...
  fetch = () => {
    ...
    let leixingmingcheng = this.props.mingcheng;
    let zhuangtai = this.props.zhuangtai;
    if(this.props.mingcheng === undefined){
      leixingmingcheng = "";
    }
    if(this.props.zhuangtai === undefined){
      zhuangtai = "";
    }
    $.ajax({
      type:'GET',
    ...
    return (
      ...
      >
        ...
        <div className='treeSideBar_org_header'>
          <span className='treeSideBar_org_header_tit'>装备类别</span>
